  ...
  return (
    ...
    >
      ...
      <div className="p-2 max-h-96 overflow-y-auto">
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("text-editor")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("mailware")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("device-control")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("network-scanner")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("system-monitor")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("security-dashboard")}
        >
          <i className="fa fa-chart-line w-6"></i>
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("animation-demo")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("social-feed")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("vulnerability-scanner")}
        >
        ...
        <div
          className="app-item p-2 rounded hover:bg-accent hover:bg-opacity-25 cursor-pointer flex items-center"
          onClick={() => handleAppClick("password-cracker")}
        >
